...
"Physics/Resonance/XSection/FKR.h" -> "Physics/Resonance/XSection/FKRDM.h"

Within FKRDM.h make the following changes from FKR.h:
  _FKR_H_ -> _FKRDM_H_
  "FKR" -> "FKRDM"
  C -> Cs and Cz
  B -> Bs and Bz
  ...
  currently use variables {Rplus,Rminus,Tplus,Tminus,R,T}.
