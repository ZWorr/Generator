           ...
           Resonance_t res, const FKRDM & fkrdm) const
{
  switch(res) {
    ...
    case (kP11_1440) :
    {
      ...
      fAmpl.fPlus3 = 0;
      fAmpl.f0Plus = (fkrdm.Lamda/2) * k1_Sqrt3 * (-3 * fkrdm.Lamda * fkrdm.S * (fQuV + 2 * fQdV) - 2 * fkrdm.Bs * (fQuA - 4 * fQdA) + fkrdm.Lamda * fkrdm.Cs * (fQuA - 4 * fQdA));
      fAmpl.f0Minus = (fkrdm.Lamda/2) * k1_Sqrt3 * (-3 * fkrdm.Lamda * fkrdm.S * (fQuV + 2 * fQdV) + 2 * fkrdm.Bs * (fQuA - 4 * fQdA) + fkrdm.Lamda * fkrdm.Cs * (4 * fQdA - fQuA));
    ...
    fAmpl.f0Plus = fkrdm.Lamda * k1_Sqrt15 * (-3 * fkrdm.Lamda * fkrdm.S * (fQuV + 2 * fQdV) - 5 * fkrdm.Bs * (fQuA - 4 * fQdA) + fkrdm.Lamda * fkrdm.Cs * (fQuA - 4 * fQdA));
    fAmpl.f0Minus = fkrdm.Lamda * k1_Sqrt15 * (3 * fkrdm.Lamda * fkrdm.S * (fQuV + 2 * fQdV) - 5 * fkrdm.Bs * (fQuA - 4 * fQdA) + fkrdm.Lamda * fkrdm.Cs * (fQuA - 4 * fQdA));
    ...
    fAmpl.f0Plus = (1/kSqrt10) * L2 * (3 * fkrdm.S * (fQuV + 2 * fQdV) - fkrdm.Cs * (fQuA - 4 * fQdA));
    fAmpl.f0Minus = (1/kSqrt10) * L2 * (3 * fkrdm.S * (fQuV + 2 * fQdV) + fkrdm.Cs * (fQuA - 4 * fQdA));
    ...
    fAmpl.fPlus3 = 0;
    fAmpl.f0Plus = fkrdm.Lamda * (1/2) * k1_Sqrt6 * (3 * fkrdm.Lamda * fkrdm.S * (fQdV - fQuV) + (fQuA + 5 * fQdA) * (fkrdm.Lamda * fkrdm.Cs - 2 * fkrdm.Bs));
    fAmpl.f0Minus = -fkrdm.Lamda * (1/2) * k1_Sqrt6 * (3 * fkrdm.Lamda * fkrdm.S * (fQuV - fQdV) + (fQuA + 5 * fQdA) * (fkrdm.Lamda * fkrdm.Cs - 2 * fkrdm.Bs));
